    ...
    public partial class MainForm : Form
    {
        ...
        private bool GetWheater()
        {
            try
            {
                ...
                {
                    string url = $"https://api.openweathermap.org/data/2.5/weather?q={tB_Schearch.Text}&units=metric&appid={apiKey}&lang=pl";
        ...
        private void bt_Save_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("Nie udało się zapisać histori pogody.");
                }
            }
        }
        ...
        private void b_History_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Nie ma żadnych plików z historią pogody.");
            }
        }
    }
}